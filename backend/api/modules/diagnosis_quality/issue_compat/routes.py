...
from backend.api.modules.diagnosis_quality.issue_compat.schemas import (
    IssueResolutionResponse,
    IssueResolveRequest,
)
from backend.api.modules.diagnosis_quality.issue_compat.application.issue_service import IssueService
