    ...
    <div className="flex-1 min-h-[100dvh] bg-[#F8FAFC] flex flex-col font-sans selection:bg-indigo-100 relative overflow-hidden">
      ...
      <header className="h-16 border-b border-slate-200/50 bg-white/60 backdrop-blur-xl flex items-center px-10 shrink-0 sticky top-0 z-20">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center text-white shadow-sm shadow-indigo-500/20">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg>
          </div>
              ...
              {sorted.map((p) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-8">
                    ...
                    <span className="px-3 py-1.5 bg-slate-100 text-slate-600 text-[10px] font-bold rounded-xl border border-slate-200/60 uppercase tracking-widest">
                      项目
                    </span>
                  </div>
