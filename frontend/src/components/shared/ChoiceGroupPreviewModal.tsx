...
const subtasksRecord: Record<string, string[]> = {
  ...
  flow: [
    ...
    "⚖️ 正在分析流程复杂度，生成 2 套不同自动化水平 of 端到端方案...",
...
const genericSubtasks = [
  "🤖 正在建立与 AI 智能体的大大语言模型连接...",
  "🧬 正在推演多套模型分歧点，以提供最佳差异对比...",
  "🔍 正在深度挖掘业务边界并生成核心场景与功能架构...",
  "⚙️ 正在执行质量完整性校验，构建多方案对比分析...",
